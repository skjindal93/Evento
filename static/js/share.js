...
jQuery(function(){
	...
	st.mouseleave(function(){ 
	    st.animate({height:'20px', width: '40px', opacity: .7}, 300,function() {
	    	jQuery('#socialdrawer img').hide();
	    }); 
	    return false;
	    }  );
